                ...
                <div className="text-center">
                    ...
                    <div className="flex justify-center mb-8 mt-4">
                        <div className="relative inline-block">
                            ...
                            <div className="absolute inset-0 bg-gradient-to-r from-emerald-400 to-cyan-500 rounded-full blur-3xl opacity-5 animate-pulse"></div>
                            {/* Llamado a la imagen SVG alojada en la carpeta public */}
                            <img
                                src="/loterias_logo.svg"
                                alt="LOTERIAS Logo Oficial"
                                className="relative z-10 w-80 md:w-[650px] h-auto object-contain drop-shadow-[0_0_20px_rgba(34,211,238,0.15)]"
                            />
                        </div>
                    </div>
