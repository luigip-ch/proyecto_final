...
import { Dna, RefreshCw, AlertCircle, CheckCircle2, Sparkles } from 'lucide-react'
          ...
          <div className="text-center">
            ...
            <div className="flex justify-center mb-8">
              <div className="relative">
                <div className="absolute inset-0 bg-gradient-to-r from-emerald-400 to-cyan-500 rounded-full blur-xl opacity-30 animate-pulse"></div>
                <div className="relative bg-gradient-to-r from-emerald-400 to-cyan-500 p-4 rounded-full">
            ...
            {/* Title */}
            <h1 className="text-5xl lg:text-7xl font-bold mb-6 bg-gradient-to-r from-white via-emerald-100 to-cyan-100 bg-clip-text text-transparent">
